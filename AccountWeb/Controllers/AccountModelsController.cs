...
namespace AccountWeb.Controllers
{
    ...
    {
        private AccountWebDBContext db = new AccountWebDBContext();
        ...
        public ActionResult Create([Bind(Include = "AccountNumber,AccountHolder,CurrentBalance,BankName,OpeningDate,IsActive")] AccountModel accountModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccountNumber,AccountHolder,CurrentBalance,BankName,OpeningDate,IsActive")] AccountModel accountModel)
        {
            if (ModelState.IsValid)
            {
